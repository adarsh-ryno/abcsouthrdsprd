...
if (!class_exists("Bluecorona_Type_A_Navwalker")) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Bluecorona_Type_A_Navwalker extends Walker_Nav_Menu
	{
		/**
		...
		public function start_el(
			...
			$classes[] = "menu-item-" . $item->ID . " depth-level-" . $depth;
			...
			if (
				...
				$icon_html =
					'&nbsp;<span class="float-right bc-nav-dropdown-icon pr-3"><i class="' .
					$args->icon_down .
			...
			$item_output .= isset($args->link_before)
				? $args->link_before . $title . $icon_html . $args->link_after
				: "";
