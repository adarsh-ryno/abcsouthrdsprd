...
if (!function_exists("understrap_theme_customize_register")) {
	...
	function understrap_theme_customize_register($wp_customize)
	{
		...
		$wp_customize->add_section("understrap_theme_layout_options", [
			"title" => __("Theme Layout Settings", "understrap"),
			"capability" => "edit_theme_options",
			"description" => __(
				"Container width and sidebar defaults",
				"understrap"
			),
			"priority" => apply_filters(
				"understrap_theme_layout_options_priority",
				160
			),
		]);
		...
		$wp_customize->add_setting("understrap_bootstrap_version", [
			"default" => "bootstrap4",
			"type" => "theme_mod",
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				[
					...
					"description" => __(
						"Choose between Bootstrap 4 or Bootstrap 5",
						"understrap"
					),
					...
					"priority" => apply_filters(
						"understrap_bootstrap_version_priority",
						10
					),
				]
			)
		...
		$wp_customize->add_setting("understrap_container_type", [
			"default" => "container",
			"type" => "theme_mod",
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				[
					...
					"priority" => apply_filters(
						"understrap_container_type_priority",
						10
					),
				]
			)
		...
		$wp_customize->add_setting("understrap_navbar_type", [
			"default" => "collapse",
			"type" => "theme_mod",
			"sanitize_callback" => "sanitize_text_field",
			"capability" => "edit_theme_options",
		...
		$wp_customize->add_control(
			new WP_Customize_Control($wp_customize, "understrap_navbar_type", [
				...
				"priority" => apply_filters(
					"understrap_navbar_type_priority",
					20
				),
			])
		);

		$wp_customize->add_setting("understrap_sidebar_position", [
			"default" => "right",
			"type" => "theme_mod",
			"sanitize_callback" => "sanitize_text_field",
			"capability" => "edit_theme_options",
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				[
					...
					"priority" => apply_filters(
						"understrap_sidebar_position_priority",
						20
					),
				]
			)
		...
		$wp_customize->add_setting("understrap_site_info_override", [
			"default" => "",
			"type" => "theme_mod",
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				[
					...
					"description" => __(
						'Override Understrap\'s site info located at the footer of the page.',
						"understrap"
					),
					"section" => "understrap_theme_layout_options",
...
add_action(
	...
	"understrap_customize_controls_js"
);
...
add_filter(
	...
	"understrap_default_navbar_type",
	20
);
