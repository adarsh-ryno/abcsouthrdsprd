...
if (!function_exists("understrap_widget_classes")) {
	...
	function understrap_widget_classes($params)
	{
		 ...
		 */
		$sidebars_widgets_count = apply_filters(
			"sidebars_widgets",
			$sidebars_widgets
		);
		...
		if (
			isset($params[0]["id"]) &&
			strpos($params[0]["before_widget"], "dynamic-classes")
		) {
...
if (!function_exists("understrap_widgets_init")) {
	...
	function understrap_widgets_init()
	{
		...
		register_sidebar([
			...
			"before_widget" =>
				'<div id="%1$s" class="static-hero-widget %2$s dynamic-classes">',
		...
		register_sidebar([
			...
			"before_widget" =>
				'<div id="%1$s" class="footer-widget %2$s dynamic-classes">',
