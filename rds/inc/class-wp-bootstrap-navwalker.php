...
if (!class_exists("Understrap_WP_Bootstrap_Navwalker")) {
	...
	class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public function start_el(
			 ...
			 */
			$classes = self::seporate_linkmods_and_icons_from_classes(
				$classes,
				$linkmod_classes,
				$icon_classes,
				$depth
			...
			if ("" !== $linkmod_type) {
				// is linkmod, output the required element opener.
				$item_output .= self::linkmod_element_close(
					$linkmod_type,
					$attributes
				);
			} else {
		...
		public static function fallback($args)
		{
			if (current_user_can("edit_theme_options")) {
				...
				$fallback_output .=
					...
					'" title="' .
					esc_attr__("Add a menu", "understrap") .
					'">' .
		 ...
		 */
		private function seporate_linkmods_and_icons_from_classes(
			$classes,
			&$linkmod_classes,
			&$icon_classes,
			$depth
