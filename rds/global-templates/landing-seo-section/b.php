...
if (isset($meta["_elementor_template_type"], $meta["_elementor_edit_mode"]) && isset($meta["_elementor_data"])) {
            ...
            <div class="container pt-lg-3 py-2">
                <div class="row py-lg-2">
                    <div class="col-lg-12 px-0 bc_homepage seosection-bc text-md-left">
                        ...
                        if ($postId == 40758) {
                        ?>
                            <?php if (!empty(get_exist_image_url("about-page", "about-img"))): ?>
                        ...
                        ?>
                            <?php if (!empty(get_exist_image_url("seo-section", "seo-img"))): ?>
                        ...
                        <?php if (!empty($args["page_templates"]["landing_page"]["landing_seo_section"]["heading"])): ?>
                            <h1 class="text-lg-start text-center"><?php echo $args["page_templates"]["landing_page"]["landing_seo_section"]["heading"]; ?></h1>
                        <?php endif; ?>

                        <?php if (!empty($args["page_templates"]["landing_page"]["landing_seo_section"]["subheading"])): ?>
                            <h2 class="pb-lg-4 text-lg-start text-center"><?php echo $args["page_templates"]["landing_page"]["landing_seo_section"]["subheading"]; ?></h2>
                        <?php endif; ?>
