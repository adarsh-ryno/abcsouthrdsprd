...
<div class="container-fluid py-lg-5 home_banner px-lg-3 px-0">
    <div class="position-relative py-lg-4 pt-5">
        <div class="container pb-lg-5 pt-lg-4 py-4 text-center">
            <div class="row pb-lg-5 py-2 my-lg-3">
                <div class="col-md-12 pt-lg-4 pb-lg-5">
                    ...
                    <?php if (!empty($args["globals"]["hero"]["button_link"]) && !empty($args["globals"]["hero"]["button_text"])) { ?>
                        <a href="<?php echo get_home_url() . $args["globals"]["hero"]["button_link"]; ?>" class="btn btn-secondary mw-227 mh-53"><?php echo $args["globals"]["hero"]["button_text"]; ?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
