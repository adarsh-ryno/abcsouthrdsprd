...
?>
    ...
    <?php if (!empty($args["globals"]["promotion"]["popup_form_heading"]) && !empty($args["globals"]["promotion"]["popup_gravity_form_id"])): ?>
        <div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0 88" id="slider_request_coupon_form" tabindex="-1" role="dialog" data-bs-backdrop="false" data-bs-keyboard="false" aria-labelledby="requestcoupon_Label" aria-hidden="true">
