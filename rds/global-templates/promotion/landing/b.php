<div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0 hh" id="landing_request_coupon_form" tabindex="-1" role="dialog" data-bs-backdrop="false" data-bs-keyboard="false" aria-labelledby="requestcoupon_Label" aria-hidden="true">
        ...
        <div class="modal-content border-0 rounded-0 text-center">
            ...
            <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                <div class="border-dashed-7 pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                    <?php if (!empty($args["page_templates"]["landing_page"]["promotion"]["popup_form_heading"])): ?>
                        <h3 class="px-lg-0 px-4">
                            <?php echo $args["page_templates"]["landing_page"]["promotion"]["popup_form_heading"]; ?>
                        </h3>
                    <?php endif; ?>

                    <?php if (!empty($args["page_templates"]["landing_page"]["promotion"]["popup_form_subheading"])): ?>
                        <div class="my-md-0 mt-lg-4 mt-3 w-lg-260 mx-auto text-start text-lg-center d-flex align-items-center justify-content-center pb-4 px-lg-0 px-4">
                            ...
                            <span class="font_alt_1 text_bold text_16 line_height_25 sm_text_16 sm_line_height_30 color_primary">
                                <?php echo $args["page_templates"]["landing_page"]["promotion"]["popup_form_subheading"]; ?>
                            </span>
                        </div>
                    <?php endif; ?>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery(".coupon-popup-close").click(function () {
                    ...
                    jQuery(this).closest("#landing_request_coupon_form").find("form .gfield_label").each(function (k, d) {
                        jQuery(d).attr("style", "");
        ...
        <div class="d-block  pb-lg-2">
            ...
            ?>
                    <div class="container px-1 px-lg-3">
                        ...
                        <div class="row mx-0">
                            <div class="homepage_coupon pt-lg-3 mt-3 pb-lg-1 px-lg-0 px-2 mx-lg-0 mx-1">   


                                <div class="coupon_slider position-relative px-3">
                                    <div class="swiper  home-coupon-swiper-b promotion-swiper-variation-b d-lg-block d-none">
                                            	...
                                            	if (
                                                    ...
                                                    <div class="swiper-slide h-auto border-quaternary-dashed  p-lg-2 p-3">
                                                        <div class="coupon_name color_primary_bg  h-coupan-100 py-4 p-4 px-lg-0 text-center" style="background-color: <?php echo $color; ?>;">
                                                            ...
                                                            <a data-bs-toggle="<?php echo empty(
                                                            	$requestButtonLink
                                                            )
                                                            	? "modal"
                                                            	: ""; ?>" 
                                                                data-bs-target="<?php echo empty(
                                                                	$requestButtonLink
                                                                )
                                                                	? "#landing_request_coupon_form"
                                                                	: ""; ?>" 
                                                                <?php echo empty(
                                                                	$requestButtonLink
                                                                )
                                                            ...
                                                            <span class="pt-lg-3 pt-2 d-block coupon_expiry px-3"><?php if (
                                                            	$noexpiry != 1
                                                            ) {
                                                            	echo "Expires " .
                                                            		$date;
                                ...
                                <div class="swiper m-promotion-swiper-variation-b d-lg-none d-block">
...
<script>
        jQuery(document).ready(function () {
            var numImage_b = jQuery('.promotion-swiper-variation-b .swiper-slide').length;
            if (numImage_b < 4) {
                jQuery('.promotion-swiper-variation-b .swiper-wrapper').addClass('justify-content-center ps-lg-3');
                new Swiper(".promotion-swiper-variation-b", {
                    spaceBetween: 30,
                    slidesPerView: 1,
                    loop: false,
                    pagination: {
                        el: ".promotion-swiper-variation-b-<?php echo $widget_id ?>",
                        clickable: true
                    },
                    navigation: {
                ...
                var mySwiper = document.querySelector('.promotion-swiper-variation-b').swiper
                document.querySelectorAll('.request_service_button').forEach(function(button) {
                    button.addEventListener('click', function() {
                        if (document.getElementById('landing_request_coupon_form').classList.contains('show')) {
            ...
            new Swiper(".m-promotion-swiper-variation-b", {
                spaceBetween: 30,
                slidesPerView: 1,
                autoplay: {
                    delay: 8000,
                ...
                loop: true,
                pagination: {
                    el: ".m-promotion-swiper-variation-b-<?php echo $widget_id ?>",
                    clickable: true
                },
                breakpoints: {
                    640: {
            ...
            if(jQuery('.m-promotion-swiper-variation-b').length == 1){
                var mySwiperb = document.querySelector('.m-promotion-swiper-variation-b').swiper
                document.querySelectorAll('.request_service_button').forEach(function(button) {
                    button.addEventListener('click', function() {
                        if (document.getElementById('landing_request_coupon_form').classList.contains('show')) {
