                                                    ...
                                                    <div class="h-auto border-quaternary-dashed p-lg-2 p-3">
                                                        <div class="coupon_name color_primary_bg h-100 py-4 p-4 px-lg-0 text-center" style="background-color: <?php echo esc_attr($colorCode); ?>;">
                                                            <?php if (!empty($heading)) { ?>
                                                                <span class="d-block text-center px-lg-0 px-3 pt-lg-0 pt-2 coupon_heading"><?php echo esc_html($heading); ?></span>
                                                            <?php } ?>
                                                            <?php if (!empty($subheading)) { ?>
                                                                <span class="d-block text-center py-2 px-lg-0 px-2 pt-2 my-lg-1 coupon_sub_heading"><?php echo esc_html($subheading); ?></span>
                                                            <?php } ?>
                                                            <?php if (!empty($title)) { ?>
                                                            ...
                                                            <?php if ($noexpiry != 1 && !empty($date)) { ?>
                                                                <span class="pt-lg-3 pt-2 d-block px-3 coupon_expiry">Expires <?php echo esc_html($date); ?></span>
                                                            <?php } ?>
...
<div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0 ee" id="request_coupon_form_template_b" tabindex="-1" role="dialog" data-bs-backdrop="false" data-bs-keyboard="false" aria-labelledby="requestcoupon_Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered px-lg-0 px-2" role="document">
        ...
        jQuery(document).ready(function () {
            jQuery(".coupon-popup-close").click(function () {
                jQuery(this).closest("#request_coupon_form_template_b").find("form .gfield_label").each(function (k, d) {
                    jQuery(d).attr("style", "");
