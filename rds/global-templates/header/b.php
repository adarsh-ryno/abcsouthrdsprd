...
?>
        ...
        <div class="container-fluid d-none hide-on-touch d-lg-block">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-3 col-sm-4 col-12 mr-0 pt-5 ">
                        <a href="<?php echo get_home_url(); ?>" class="d-inline-block mt-3 position-relative z-index">
	...
	"header-logo"
 	...
 	"header-logo@3x"
                    ...
                    <div class="col-lg-9 text-end pt-1 pb-2">
                        <div class="d-lg-flex align-items-center justify-content-end font_default pt-2">
                        <span class=" pt-1 mb-0 call_today">
 ...
 ?>" class=" phone_number">
        ...
        <?php get_template_part(
        	"global-templates/nav/desktop/b",
        	null,
        	$args
        ); ?>
